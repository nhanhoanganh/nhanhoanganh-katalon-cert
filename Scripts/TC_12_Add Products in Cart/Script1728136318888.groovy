...
WebUI.mouseOver(findTestObject('Object Repository/Page_Automation Exercise - All Products/div_Rs. 400Men TshirtAdd to cart'))

WebUI.click(findTestObject('Object Repository/Page_Automation Exercise - All Products/a_Add to cart_1'))
