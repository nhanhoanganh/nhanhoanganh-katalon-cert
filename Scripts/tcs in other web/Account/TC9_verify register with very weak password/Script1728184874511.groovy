...
WebUI.setText(findTestObject('Page_My Account  Automation Practice Site/input__password'), '123')

WebUI.verifyElementPresent(findTestObject('Page_My Account  Automation Practice Site/div_Very weak - Please enter a stronger password'), 
    0)
