...
WebUI.setEncryptedText(findTestObject('Page_My Account  Automation Practice Site/input__password'), 'FXCORoDhUVc=')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_My Account  Automation Practice Site/div_Weak - Please enter a stronger password'), 
    0)
